package org.nghru_uk.ghru.ui.registerpatient_sg.confirmation
...
import org.nghru_uk.ghru.databinding.ConfirmationFragmentSgBinding
...
class ConfirmationFragmentSG : Fragment(), Injectable {
    @Inject
    lateinit var viewModelFactory: ViewModelProvider.Factory


    var binding by autoCleared<ConfirmationFragmentSgBinding>()
    var dataBindingComponent: DataBindingComponent = FragmentDataBindingComponent(this)
    @Inject
    lateinit var confirmationViewModel: ConfirmationViewModelSG
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<ConfirmationFragmentSgBinding>(
            inflater,
            R.layout.confirmation_fragment_sg,
            container,
            false
        )
        binding = dataBinding
