package org.nghru_uk.ghru.ui.bodymeasurements.bp
...
import org.nghru_uk.ghru.databinding.BpFragmentBinding
import org.nghru_uk.ghru.di.Injectable
import org.nghru_uk.ghru.ui.scan.BleScanActivity
    ...
    protected fun onReceiveMessage(msg: Message) {
        ...
        when (messageType) {
            ...
            MessageType.BatteryDataRcv -> {
                ...
                //TimberbleInfo("Battery Level Raw StationParticipant:" + Utils.byteDataToHexString(batteryData))
                // val batteryLevel = batteryData[0].toInt()
                //TimberbleInfo("Battery Level StationParticipant:$batteryLevel")
            }
            MessageType.CTSDataRcv -> {
//                val ctsData = msg.obj as ByteArray
//                //TimberbleInfo("Current Time Raw StationParticipant:" + Utils.byteDataToHexString(ctsData))
//                val buf = ByteArray(2)
...
//                        ctsYear, ctsMonth, ctsDay, ctsHour, ctsMinute, ctsSecond)
                ...
                //TimberbleInfo("CTS StationParticipant:$ctsTime (AdjustReason:$AdjustReason)")
...
//                }
        ...
        when (messageType) {
            MessageType.BPMDataRcv -> {
                ...
                Timber.d("Blood Pressure Measurement Raw StationParticipant:" + byteDataToHexString(data))
                ...
                if (timestampFlag) {
                    ...
                    Timber.d("Timestamp StationParticipant:$timestampStr")
                }
                ...
                if (pulseRateFlag) {
                    ...
                    Timber.d("PulseRate StationParticipant:$pulseRateStr")
                }
                ...
                if (userIdFlag) {
                    ...
                    Timber.d("UserID StationParticipant:$userIDStr")
                }
                ...
                if (measurementStatusFlag) {
                    ...
                    Timber.d("MeasurementStatus StationParticipant:$measurementStatusStr")
...
//                        + "," + measurementStatusStr)
            ...
            MessageType.BPFDataRcv -> {
                data = msg.obj as ByteArray
                Timber.d("Blood Pressure Feature Raw StationParticipant:" + byteDataToHexString(data))
                ...
                Timber.d("Blood Pressure Feature StationParticipant:$bpfStr")
            }
    ...
    private fun getCurrentTimeData(): ByteArray {
        ...
        //TimberbleInfo("CTS Tx StationParticipant:" + sb.toString())
        return data
    }
            ...
            BleEvent.Type.WriteCharacteristic -> {
                if (GattUUID.Characteristic.CurrentTimeCharacteristic.uuid == characteristic.uuid) {
                    ...
                    if (GattStatusCode.GATT_SUCCESS == gattStatus) {
                        ...
                        // The status, 0x80 (StationParticipant filed ignored) will be notified same status to the application
