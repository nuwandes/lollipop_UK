package org.nghru_uk.ghru.ui.registerpatient_sg.scanqrcode
...
import org.nghru_uk.ghru.databinding.RegisterScanQrCodeFragmentBinding
...
class ScanQRCodeFragmentSG : Fragment(), Injectable {
    ...
    @Inject
    lateinit var viewModel: ScanQRCodeViewModelSG
