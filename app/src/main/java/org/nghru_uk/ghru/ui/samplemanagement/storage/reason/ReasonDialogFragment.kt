package org.nghru_uk.ghru.ui.samplemanagement.storage.reason
...
import org.nghru_uk.ghru.databinding.StorageReasonDialogFragmentBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.buttonAcceptAndContinue.singleClick {
            ...
            if (binding.radioGroup.checkedRadioButtonId == -1) {
                ...
                if(binding.radioButtonTubeMissing.isChecked)
                    cancelRequest.reason = binding.radioButtonTubeMissing.text.toString()
                else if(binding.radioButtonTubeBroken.isChecked)
