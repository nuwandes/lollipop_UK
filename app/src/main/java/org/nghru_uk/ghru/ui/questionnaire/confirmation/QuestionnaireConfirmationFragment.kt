...
class QuestionnaireConfirmationFragment : Fragment() , Injectable {
    ...
    var binding by autoCleared<QuestionnaireConfirmationFragmentBinding>()
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<QuestionnaireConfirmationFragmentBinding>(
            inflater,
            R.layout.questionnaire_confirmation_fragment,
            container,
            false
        )
        binding = dataBinding
