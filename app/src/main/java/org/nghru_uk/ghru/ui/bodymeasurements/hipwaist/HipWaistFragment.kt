...
import org.nghru_uk.ghru.databinding.HipWaistFragmentBinding
...
import org.nghru_uk.ghru.ui.bodymeasurements.hipwaist.reason.ReasonDialogFragment
...
//            bodyMeasurementValue.comment = "Reason by Mujeeb create body Hip"
        ...
        onTextChanges(binding.waistSizeEditText)
        onTextChanges(binding.hipSizeEditText)
    }
    ...
    private fun onTextChanges(editText: EditText) {
        editText.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(p0: Editable?) {
                if(editText == binding.waistSizeEditText) {
                    validateWaistSize(binding.waistSizeEditText.text.toString())
                }

                if(editText == binding.hipSizeEditText) {
                    validateHipSize(binding.hipSizeEditText.text.toString())
                }
            }
