package org.nghru_uk.ghru.ui.registerpatient.confirmation.completed
...
class CompletedDialogFragment : DialogFragment(), Injectable {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        //binding.newMemberButton.visibility = View.VISIBLE
        ...
        binding.homeButton.singleClick {
            //activity?.finish()
            dismiss()
            findNavController().navigate(R.id.action_global_consentFragment, bundleOf("participantMeta" to participantMeta))
            // need to navigate to consent upload screen
        }
    }
