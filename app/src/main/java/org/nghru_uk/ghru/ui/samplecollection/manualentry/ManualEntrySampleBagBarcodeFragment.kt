...
import org.nghru_uk.ghru.databinding.SamplecollectionManualBagBarcodeFragmentBinding
    ...
    override fun onCreateView(
        ...
        viewModel.screeningIdCheck?.observe(this, Observer { householdId ->
            ...
            if (householdId?.status == Status.SUCCESS) {
                ...
                findNavController().navigate(R.id.action_global_bagScannedFragment, bundle)
            }
