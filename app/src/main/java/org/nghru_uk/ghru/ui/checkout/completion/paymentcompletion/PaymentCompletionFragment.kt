...
import org.nghru_uk.ghru.databinding.PaymentCompletionFragmentBinding
...
class PaymentCompletionFragment : Fragment(), Injectable {
    ...
    var binding by autoCleared<PaymentCompletionFragmentBinding>()

    @Inject
    lateinit var viewModel: PaymentCompletionViewModel
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<PaymentCompletionFragmentBinding>(
            inflater,
            R.layout.payment_completion_fragment,
            container,
            false
        )
        binding = dataBinding
