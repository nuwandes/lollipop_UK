package org.nghru_uk.ghru.ui.registerpatient_sg.identification
...
class IdentificationFragmentSG : Fragment(), Injectable {
    @Inject
    ...
    @Inject
    lateinit var viewModel: IdentificationViewModelSG
