package org.nghru_uk.ghru.ui.samplecollection.bagscanbarcode
...
import org.nghru_uk.ghru.databinding.BagScanBarcodeFragmentBinding
...
import org.nghru_uk.ghru.util.validateChecksum
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.screeningIdCheck?.observe(this, Observer { householdId ->
            ...
            if (householdId?.status == Status.SUCCESS) {
                ...
                //Navigation.findNavController(activity!!, R.id.container).navigate(R.id.action_bagScanBarcodeFragment_to_bagScannedFragment, bundle)
                Navigation.findNavController(activity!!, R.id.container).navigate(R.id.action_global_bagScannedFragment, bundle)
            }
