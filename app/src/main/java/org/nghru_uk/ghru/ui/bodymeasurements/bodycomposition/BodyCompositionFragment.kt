package org.nghru_uk.ghru.ui.bodymeasurements.bodycomposition
...
import org.nghru_uk.ghru.databinding.BodyCompositionFragmentBinding
...
import org.nghru_uk.ghru.ui.bodymeasurements.bodycomposition.reason.ReasonDialogFragment
...
//            bodyMeasurementValueMuscle.value = "30.1"
        ...
        onTextChanges(binding.bodycompositionEditText)
        onTextChanges(binding.fatcomEditText)
        onTextChanges(binding.visceralEditText)
        onTextChanges(binding.muscleEditText)
    }
    ...
    private fun onTextChanges(editText: EditText) {
        editText.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(p0: Editable?) {
                if(editText == binding.bodycompositionEditText) {
                    validateWeight(binding.bodycompositionEditText.text.toString())
                }

                if(editText == binding.fatcomEditText) {
                    validateFatCom(binding.fatcomEditText.text.toString())
                }

                if(editText == binding.visceralEditText) {
                    validateVisceral(binding.visceralEditText.text.toString())
                }

                if(editText == binding.muscleEditText) {
                    validateMuscle(binding.muscleEditText.text.toString())
                }
            }
