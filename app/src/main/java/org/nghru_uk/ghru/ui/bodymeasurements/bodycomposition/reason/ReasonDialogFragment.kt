package org.nghru_uk.ghru.ui.bodymeasurements.bodycomposition.reason
...
import org.nghru_uk.ghru.databinding.BmBcReasonDialogFragmentBinding
...
class ReasonDialogFragment : DialogFragment(), Injectable {
    ...
    var binding by autoCleared<BmBcReasonDialogFragmentBinding>()
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<BmBcReasonDialogFragmentBinding>(
            inflater,
            R.layout.bm_bc_reason_dialog_fragment,
            container,
            false
        )
        binding = dataBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.buttonAcceptAndContinue.singleClick {
            ...
            if (binding.radioGroup.checkedRadioButtonId == -1) {
                ...
                if(binding.radioButtonParticipantFactor.isChecked)
                    cancelRequest.reason = binding.radioButtonParticipantFactor.text.toString()
                else if(binding.radioButtonTechnicalProblem.isChecked)
                    cancelRequest.reason = binding.radioButtonTechnicalProblem.text.toString()
