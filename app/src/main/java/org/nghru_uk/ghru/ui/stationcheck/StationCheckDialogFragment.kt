package org.nghru_uk.ghru.ui.stationcheck
...
import org.nghru_uk.ghru.databinding.StationCheckDialogFragmentBinding
...
class StationCheckDialogFragment : DialogFragment(), Injectable {

    val TAG = StationCheckDialogFragment::class.java.getSimpleName()


    @Inject
    lateinit var viewModelFactory: ViewModelProvider.Factory
    var binding by autoCleared<StationCheckDialogFragmentBinding>()
    var dataBindingComponent: DataBindingComponent = FragmentDataBindingComponent(this)

    @Inject
    lateinit var viewModel: StationCheckDialogViewModel
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<StationCheckDialogFragmentBinding>(
            inflater,
            R.layout.station_check_dialog_fragment,
            container,
            false
        )
        binding = dataBinding
