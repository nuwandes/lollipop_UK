package org.nghru_uk.ghru.ui.bodymeasurements.manualentrybp
...
//        })
        ...
        Log.d("BP_MANUAL_FRAGMENT", "META_DATA: ON_LOAD" + meta!! + "END_TIME: " + meta!!.endTime)
...
//                        .navigate(R.id.action_manualScanFragment_to_measurementsFragment, bundle)
                } else {
