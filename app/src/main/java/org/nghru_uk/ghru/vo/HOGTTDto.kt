...
data class HOGTTDto(
    ...
    companion object CREATOR : Parcelable.Creator<HOGTTDto> {
        override fun createFromParcel(parcel: Parcel): HOGTTDto {
            return HOGTTDto(parcel)
        }

        override fun newArray(size: Int): Array<HOGTTDto?> {
