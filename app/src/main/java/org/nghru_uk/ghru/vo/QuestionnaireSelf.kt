...
@Entity(tableName = "questionnaire_self")
data class QuestionnaireSelf(
    ...
    companion object CREATOR : Parcelable.Creator<QuestionnaireSelf> {
        override fun createFromParcel(parcel: Parcel): QuestionnaireSelf {
            return QuestionnaireSelf(parcel)
        }

        override fun newArray(size: Int): Array<QuestionnaireSelf?> {
