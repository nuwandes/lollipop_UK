...
data class TotalCholesterolDto(
    ...
    companion object CREATOR : Parcelable.Creator<TotalCholesterolDto> {
        override fun createFromParcel(parcel: Parcel): TotalCholesterolDto {
            return TotalCholesterolDto(parcel)
        }

        override fun newArray(size: Int): Array<TotalCholesterolDto?> {
