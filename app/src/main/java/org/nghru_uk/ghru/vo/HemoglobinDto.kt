...
class HemoglobinDto (
    ...
    companion object CREATOR : Parcelable.Creator<HemoglobinDto> {
        override fun createFromParcel(parcel: Parcel): HemoglobinDto {
            return HemoglobinDto(parcel)
        }

        override fun newArray(size: Int): Array<HemoglobinDto?> {
