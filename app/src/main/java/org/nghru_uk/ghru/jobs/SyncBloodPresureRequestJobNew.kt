...
import org.nghru_uk.ghru.sync.BloodPressureMetaRequestRxBus
import org.nghru_uk.ghru.sync.BloodPressureMetaRequestRxBusNew
...
class SyncBloodPresureRequestJobNew(
    private var screeningId: String,
    private var bloodPresureMetaRequest: BloodPressureMetaRequestNew
) : Job(
    ...
    override fun onRun() {
        ...
        RemoteHouseholdService().getInstance().addBloodPressuerMetaRequestSyncNew(screeningId, bloodPresureMetaRequest)
        BloodPressureMetaRequestRxBusNew.getInstance().post(SyncResponseEventType.SUCCESS, bloodPresureMetaRequest)
    }
    ...
    override fun onCancel(cancelReason: Int, throwable: Throwable?) {
        ...
        BloodPressureMetaRequestRxBusNew.getInstance().post(SyncResponseEventType.FAILED, bloodPresureMetaRequest)
    }
