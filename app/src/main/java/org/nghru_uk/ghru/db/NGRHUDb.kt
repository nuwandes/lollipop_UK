...
@Database(
    entities = [
        ...
        Axivity :: class,
        BloodPresureItemRequestNew::class,
        BloodPresureRequestNew::class,
...
abstract class NGRHUDb : RoomDatabase() {
    ...
    abstract fun bloodPressureItemRequestDaoNew(): BloodPresureItemRequestDaoNew

    abstract fun bloodPressureRequestDaoNew(): BloodPresureRequestDaoNew
